            ...
            <View style={{ paddingLeft: 25, paddingRight: 25, marginTop: 10 }}>
                ...
                <View>
                    ...
                    {info == false ? (
                        ...
                        <ScrollView showsVerticalScrollIndicator={false} style={{ height: 520 }}>
                            <View style={{ minHeight: 100, backgroundColor: colors.tertiary_light, orderColor: colors.primary, borderWidth: 0, borderRadius: 25 }}>
                                <View style={{ margin: 20, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                    ...
                                    <View style={{ flex: 1 }}>
                                        <Text numberOfLines={1} style={[desc.desc_text_8]}>No Name</Text>
                                        <Text style={desc.desc_text_9}>{"10 Feb 2022 at 11:30 am"}</Text>
                                    </View>
                                    <View  >
                                ...
                                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                    <TouchableOpacity style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginLeft: 20, marginRight: 20, marginTop: 0, marginBottom: 20 }}>
