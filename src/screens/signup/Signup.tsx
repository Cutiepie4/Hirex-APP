import { StyleSheet, View, Text, TextInput, Pressable, TouchableOpacity, TouchableWithoutFeedback, Keyboard } from 'react-native'
...
const Signup = () => {
    ...
    const handleSigupPress = () => {
        if (!password || !phoneNumber || !retryPassword) {
